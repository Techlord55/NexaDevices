        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1">
            ...
            <div className="flex space-x-4 mt-6">
              {/* Facebook */}
              <a href="#" className="text-gray-400 hover:text-electric transition-colors" aria-label="Facebook">
              ...
              {/* Twitter/X */}
              <a href="#" className="text-gray-400 hover:text-electric transition-colors" aria-label="Twitter">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              {/* Instagram */}
              <a href="#" className="text-gray-400 hover:text-electric transition-colors" aria-label="Instagram">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              {/* GitHub */}
              <a href="#" className="text-gray-400 hover:text-electric transition-colors" aria-label="GitHub">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
